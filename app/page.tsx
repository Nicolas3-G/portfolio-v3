...
export default function Home() {
  return (
    <div id="top">
      <main className="relative z-0 -mt-16 h-screen min-h-[400px] overflow-hidden">
        ...
        <div className="absolute left-4 top-20 z-10 sm:left-8 sm:top-24">
          <div className="relative min-w-[24rem] border border-zinc-200/70 bg-[#F6F3EA]/90 px-7 py-6 shadow-[0_18px_45px_rgba(15,23,42,0.35)] backdrop-blur-md">
            ...
            <h1 className="mt-3 text-3xl font-semibold tracking-tight text-accent-gold sm:text-4xl">
              Nicolas
            </h1>
      ...
      <section
        id="skills"
        className="flex min-h-[33.333vh] flex-col bg-[#F6F3EA] px-4 py-12 scroll-mt-28 sm:px-8"
      >
        ...
        <div className="mx-auto mt-10 grid w-full max-w-5xl grid-cols-1 gap-10 sm:grid-cols-3">
          <div className="flex flex-col items-center text-center">
            <div className="flex items-center gap-2.5">
              <svg className="h-5 w-5 shrink-0 text-accent-gold" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="text-sm font-semibold uppercase tracking-[0.18em] text-zinc-700">Frontend</span>
            </div>
            <div className="mt-4 flex flex-wrap justify-center gap-6">
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">Next.js</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">HTML5</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">React</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">JavaScript</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">TypeScript</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path fill="currentColor" d="M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.78-1.653-3.542-2.602-4.887-2.602-.41 0-.783.093-1.106.278-1.375.793-1.683 3.264-.973 6.365C1.98 8.917 0 10.42 0 12.004c0 1.59 1.99 3.097 5.043 4.03-.704 3.113-.39 5.588.988 6.38.32.187.69.275 1.102.275 1.345 0 3.107-.96 4.888-2.624 1.78 1.654 3.542 2.603 4.887 2.603.41 0 .783-.09 1.106-.275 1.374-.792 1.683-3.263.973-6.365C22.02 15.096 24 13.59 24 12.004c0-1.59-1.99-3.097-5.043-4.032.704-3.11.39-5.587-.988-6.38-.318-.184-.688-.277-1.092-.278zm-.005 1.09v.006c.225 0 .406.044.558.127.666.382.955 1.835.73 3.704-.054.46-.142.945-.25 1.44-.96-.236-2.006-.417-3.107-.534-.66-.905-1.345-1.727-2.035-2.447 1.592-1.48 3.087-2.292 4.105-2.295zm-9.77.02c1.012 0 2.514.808 4.11 2.28-.686.72-1.37 1.537-2.02 2.442-1.107.117-2.154.298-3.113.538-.112-.49-.195-.964-.254-1.42-.23-1.868.054-3.32.714-3.707.19-.09.4-.127.563-.132zm4.882 3.05c.455.468.91.992 1.36 1.564-.44-.02-.89-.034-1.345-.034-.46 0-.915.01-1.36.034.44-.572.895-1.096 1.345-1.565zM12 8.1c.74 0 1.477.034 2.202.093.406.582.802 1.203 1.183 1.86.372.64.71 1.29 1.018 1.946-.308.655-.646 1.31-1.013 1.95-.38.66-.773 1.288-1.18 1.87-.728.063-1.466.098-2.21.098-.74 0-1.477-.035-2.202-.093-.406-.582-.802-1.204-1.183-1.86-.372-.64-.71-1.29-1.018-1.946.303-.657.646-1.313 1.013-1.954.38-.66.773-1.286 1.18-1.868.728-.064 1.466-.098 2.21-.098zm-3.635.254
-.288-.048-.6-.168-.84-.096-.192-.264-.264-.528-.264-.48 0-.72.264-.72.84s.288.888.792 1.08c.696.288 1.608.744 1.92 1.296.264.432.408.984.408 1.656.024 1.608-.888 2.592-2.472 2.592-1.68 0-2.424-1.056-2.448-2.688h1.68c0 .744.264 1.176.792 1.176.264 0 .456-.072.552-.24.216-.312.264-1.176-.048-1.512-.288-.408-.888-.6-1.32-.816-.552-.264-.96-.576-1.2-.936s-.36-.888-.36-1.536c-.024-1.44.912-2.472 2.4-2.448m-11.031.018c.711-.006 1.419.198 1.839.63.432.432.672 1.128.648 1.992H9.336c.024-.456-.096-.792-.432-.96-.312-.144-.768-.048-.888.24-.12.264-.192.576-.168.864v3.504c0 .744.264 1.128.768 1.128a.65.65 0 0 0 .552-.264c.168-.24.192-.552.168-.84h1.776c.096 1.632-.984 2.712-2.568 2.688-1.536 0-2.496-.864-2.472-2.472v-4.032c0-.816.24-1.44.696-1.848.432-.408 1.146-.624 1.857-.63" />
                </svg>
                <span className="text-sm font-medium text-zinc-700">CSS3</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">Redux</span>
              </div>
            </div>
          </div>
          <div className="flex flex-col items-center text-center">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-semibold uppercase tracking-[0.18em] text-zinc-700">Backend</span>
            </div>
            <div className="mt-4 flex flex-wrap justify-center gap-6">
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">Node.js</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path fill="currentColor" d="M17.193 9.555c-1.264-5.58-4.252-7.414-4.573-8.115-.28-.394-.53-.954-.735-1.44-.036.495-.055.685-.523 1.184-.723.566-4.438 3.682-4.74 10.02-.282 5.912 4.27 9.435 4.888 9.884l.07.05A73.49 73.49 0 0111.91 24h.481c.114-1.032.284-2.056.51-3.07.417-.296.604-.463.85-.693a11.342 11.342 0 003.639-8.464c.01-.814-.103-1.662-.197-2.218zm-5.336 8.195s0-8.291.275-8.29c.213 0 .49 10.695.49 10.695-.381-.045-.765-1.76-.765-2.405z" />
                </svg>
                <span className="text-sm font-medium text-zinc-700">MongoDB</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">Python</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">GCP</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">AWS</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">Firebase</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
              ...
              <div className="group flex flex-col items-center gap-2">
                ...
                <span className="text-sm font-medium text-zinc-700">Express</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path fill="currentColor" d="M4 4h4v4H4V4zm0 6h4v4H4v-4zm0 6h16v4H4v-4zm6-12h10v4H10V4zm0 6h10v4H10v-4z" />
                </svg>
                <span className="text-sm font-medium text-zinc-700">REST APIs</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path fill="currentColor" d="M12 2a4 4 0 00-4 4v2H6a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-8a2 2 0 00-2-2h-2V6a4 4 0 00-4-4zm0 2a2 2 0 012 2v2h-4V6a2 2 0 012-2zm-2 8a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1h-2a1 1 0 01-1-1v-4z" />
                </svg>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-semibold uppercase tracking-[0.18em] text-zinc-700">Other</span>
            </div>
            <div className="mt-4 flex flex-wrap justify-center gap-6">
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">Git</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path fill="currentColor" d="M24 22.525H0l12-21.05 12 21.05z" />
                </svg>
                <span className="text-sm font-medium text-zinc-700">Vercel</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
              ...
              <div className="group flex flex-col items-center gap-2">
                ...
                <span className="text-sm font-medium text-zinc-700">Expo</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path fill="currentColor" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z" />
                </svg>
                <span className="text-sm font-medium text-zinc-700">AI Integration</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">VS Code</span>
              </div>
              <div className="group flex flex-col items-center gap-2">
                <svg className="h-8 w-8 text-accent-gold transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <span className="text-sm font-medium text-zinc-700">Unreal Engine</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section
        id="projects"
        className="flex flex-col bg-[#F6F3EA] px-4 py-12 pb-20 scroll-mt-28 sm:px-8"
      >
      ...
      <section
        id="about"
        className="flex flex-col bg-[#F6F3EA] px-4 py-12 pb-24 scroll-mt-28 sm:px-8"
      >
        <div className="flex justify-center">
          <h2 className="text-3xl font-semibold tracking-tight text-zinc-900 sm:text-4xl">
            About Me
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_auto] lg:gap-16">
            <div className="flex flex-col gap-6">
              <p className="text-base leading-relaxed text-zinc-700 sm:text-lg">
                I&apos;m a fullstack developer who loves turning ideas into polished products, from
                mobile apps to web platforms. I&apos;ve spent the last 4+ years as a founding engineer,
                building systems end-to-end and shipping features that users actually enjoy.
              </p>
              <p className="text-base leading-relaxed text-zinc-700 sm:text-lg">
                When I&apos;m not coding I&apos;m playing guitar and writing songs, making jewelry,
                or volunteering at non-profits where I organize fundraising efforts, teach classes, and host meetup groups.
              </p>
              <div className="mt-2 flex flex-wrap gap-3">
                <a
                  href="mailto:nicguimont@gmail.com"
                  className="inline-flex items-center gap-2 rounded-full border border-zinc-200/70 bg-white/80 px-4 py-2.5 text-sm font-medium text-zinc-700 shadow-sm transition-colors hover:border-accent-gold/50 hover:text-accent-gold"
                >
            ...
            <div className="flex shrink-0 justify-center lg:justify-end">
              <div className="relative h-56 w-56 overflow-hidden border border-zinc-200/70 bg-zinc-100 shadow-[0_16px_40px_rgba(15,23,42,0.12)] sm:h-64 sm:w-64">
                <img
                  src="/pfp-bottom.jpg"
                  alt="Nicolas looking up in a forest"
                  className="h-full w-full object-cover"
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-start">
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <p className="mt-4 max-w-xl text-base leading-relaxed text-zinc-700 sm:text-lg">
                Whether you&apos;re looking for a founding engineer, help shipping a product, or
                just want to chat about an idea, I&apos;d love to hear from you.
              </p>
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                ...
                <a
                  href="https://cal.com/nicolas-onb3ya"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 border border-zinc-200/70 bg-white/80 px-5 py-2.5 text-sm font-medium text-zinc-700 shadow-sm transition-colors hover:border-accent-gold/50 hover:text-accent-gold"
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3M5 11h14M5 9a2 2 0 012-2h10a2 2 0 012 2v9a2 2 0 01-2 2H7a2 2 0 01-2-2V9z" />
                  </svg>
                  Schedule a call
                </a>
              </div>
